...
export const screens: Screen[] = [
  ...
  },
  {
    ...
    name: "Claim username",
    group: "First visit",
    description: "A logo, a field labeled Claim Username, and a round Begin action over an animated phase field. Style and color are assigned automatically.",
    try: "Enter a name and tap Begin to start today’s five questions. Try taken to preview an unavailable name. Saves here are simulated.",
