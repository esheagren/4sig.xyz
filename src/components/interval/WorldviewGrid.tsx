const topics = [
  ...
  { name: 'Biology & biotechnology', examples: 'Genes, cells & medicine', icon: <><path d="M11 4c0 14 14 14 14 28M25 4c0 14-14 14-14 28M12 8h12M14 13h8M14 23h8M12 28h12"/></> },
  { name: 'Economics & trade', examples: 'Work, wealth & exchange', icon: <><path d="M6 29h25M8 29V19h5v10m3 0V13h5v16m3 0V7h5v22M7 11l8-5"/></> },
  { name: 'Health & longevity', examples: 'Disease, care & lifespans', icon: <><circle cx="18" cy="18" r="13"/><path d="M15 10h6v5h5v6h-5v5h-6v-5h-5v-6h5z"/></> },
